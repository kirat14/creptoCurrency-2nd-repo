<?php get_header() ?>
    ...
    <section class="pt-lg-4 mt-lg-3 pb-5 mb-5">
                    ...
                    <div class="">
                        <div class="text-white">
                            ...
                            <div class="d-flex flex-row position-relative mt-5">
                                ...
                                <div class="p-0 mx-5">
                                    <h3 class="text-primary mb-0 me-5 pe-2">$280B</h3>
        ...
        <section class="second-section pt-5 mt-5">
            <div class="row">
                <div class="col">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                                    <div class="row justify-content-center mt-5 mb-5 pt-5">
                                <div class="col-md-6 col-lg-3">
                                    <div class="">
                                        <h3 class="text-white mb-0 me-5">15M+</h3>
                                        <p class="text-primary display-4">Businesses</p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3">
                                    <div class="">
                                        <h3 class="text-white mb-0 me-5">200M+</h3>
                                        <p class="text-primary display-4">Business Contacts</p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3">
                                    <div class="">
                                        <h3 class="text-white mb-0 me-5">400+</h3>
