<?php get_header() ?>
<main>
    <section class="pt-lg-4 mt-lg-3 pb-lg-5 mb-5 position-relative">
        <div class="container-fluid position-absolute" style="z-index: -2;">
            <div class="row">
                <div class="med-responsive-mobile-image offset-lg-5 col-lg-7 position-relative pe-0">
        ...
        <div class="container">
            <div class="row pt-5">
                <div class="col-lg-6 pb-5">
                    <div>
                        <h1 class="text-center text-lg-start">Increase Your Sales With Our High Quality <span class="">Leads</span></h1>
                        ...
                        <div class="d-none d-lg-block mt-4 mb-4">
                            <ul class="list-group list-group-horizontal p-0 display-6">
                                <li class="d-flex list-group-item"> <span><i class="fa-solid fa-check text-secondary me-2 pe-2"></i></span> Targeted Data</li>
                                <li class="d-flex list-group-item"> <span><i class="fa-solid fa-check text-secondary me-2 pe-2"></i></span>Quality Leads</li>
                                <li class="d-flex list-group-item"> <span><i class="fa-solid fa-check text-secondary me-2 pe-2"></i></span>Right Party Contacts</li>
                            </ul>
                        </div>
                        ...
                        <div class="d-flex flex-row position-relative mt-5 px-lg-0 gap-md-5 gap-sm-3 gap-2 justify-content-center justify-content-lg-start">
    ...
    <section class="second-section pt-lg-5 mt-5">
        <div class="row">
            <div class="col-lg mb-4">
                <img src="http://localhost/creptoCurrency-2nd-repo/wp-content/themes/understrap-main/img/hero-2.png" alt="">
            </div>
